...
String getChangelogString() {
  return """
    ...
    When tapping support, Budgy Pro options highlight
    ...
    < 3.8.0
    Budgy pro background now extends past scrollable area - support for (i) over-scroll
